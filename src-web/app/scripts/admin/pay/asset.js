    ...
    $(function(){
        ...
        (function(){
            ...
            formValidate = cardForm.validate({
                ...
                submitHandler:function(form){
                    ...
                    if( flag ){
                        $.ajax({
                            url:'/admin/finance/asset/addBindBankCard',
                            method:'POST',
                            data:{
        ...
        (function(){
            function beforeFn(){
                ...
                $.ajax({
                    url:'/admin/finance/asset/sendBindCardAuthCode',
                    method:'GET',
                    async:false,
                    success:function(response){
        ...
        $("input").blur(function(){
            ...
            if($(this).attr("id")=="cardAccountName"){
                $(this).valid();
            }
        });
        //删除绑定银行卡
        ...
        $("#delBtn").on("click",function(){
            ...
            $.ajax({
                url:'/admin/finance/asset/deleteBankCard/',
                type:'POST',
                data:{'id':bankCardId},
                success:function(){
                    $("#modal_2").modal("hide");
        ...
        (function(){
            $("#checkBtn").on("click",function(){
                ...
                if($checkMoney==''){
                    ...
                    $.ajax({
                        url:'/admin/finance/asset/validateBankCard',
                        type:'POST',
                        data:{
