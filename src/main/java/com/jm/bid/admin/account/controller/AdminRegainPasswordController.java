 ...
 */
@Api(tags = "jm-admin-regainPwd")
@Controller
@RequestMapping("/admin/regainPwd")
public class AdminRegainPasswordController {
    ...
    public String regainIdentity() {
        return "/admin/regainpwd/regainPwd";
    }
    ...
    public ResponseEntity regainIdentity(@RequestParam("securePhone") String securePhone, @RequestParam("imgCode") String imgCode) {
        Admin admin = adminService.loadBySecurePhone(securePhone);
        if (!StringUtils.contains(adminSession.getImgCode(), imgCode)) {
    ...
    public String regainPwd(@RequestParam("k") String uuId, Model model) {
        ...
        return "/admin/regainpwd/regainIdentity";
    }
    ...
    public ResponseEntity<?> sendCustomerVerifyCode(@RequestParam("k") String uuId) {
        ...
        return new ResponseEntity<>(authCodeService.sendVerifyCode(log.getSecurePhone(), AuthCodeType.adminRegainPwd), HttpStatus.OK);
    }
    ...
    public ResponseEntity regainPwd(@RequestParam("k") String uuId, String authCode) {
        ...
        } else if ((authCodeErrorType = authCodeService.validateAuthCode(log.getSecurePhone(), AuthCodeType.adminRegainPwd, authCode)) != AuthCodeErrorType.Auth_Success) {
    ...
    public String resetPwd(@RequestParam("k") String uuId, Model model) {
        ...
        model.addAttribute("k", uuId);
        model.addAttribute("securePhone", log.getSecurePhone());
        return "/admin/regainpwd/resetPwd";
    }
    ...
    public ResponseEntity resetPwd(@RequestParam("k") String uuId, @RequestParam("plainPassword") String plainPassword, @RequestParam("confirmPassword") String confirmPassword) {
        ...
        if (adminService.validPasswordEquals(log.getSecurePhone(), plainPassword)) {
            return new ResponseEntity("prevPasswordEquals", HttpStatus.OK);
        }
        adminService.updatePassword(log.getSecurePhone(), plainPassword);
    ...
    public String resetPwdSuccess() {
        return "/admin/regainpwd/resetPwdSuccess";
    }
